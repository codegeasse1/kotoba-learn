...
object JpN4 {
    ...
    val lessons = listOf(
        L.ja("j4-01", "Body & health", "🩺", "Headaches, fevers and medicine — describe how you feel.", "N4", """
            あたま|atama|頭|head|सिर
            おなか|onaka|お腹|stomach|पेट
            のど|nodo|喉|throat|गला
            ねつ|netsu|熱|fever|बुखार
            かぜ|kaze|風邪|cold (illness)|ज़ुकाम
            くすり|kusuri|薬|medicine|दवा
            いたい|itai|痛い|painful / hurts|दर्द होना
        ...
        L.ja("j4-02", "Emotions & feelings", "🎭", "Happy, sad, worried, excited — say how you really feel.", "N4", """
            ...
            おこる|okoru|怒る|to get angry|गुस्सा होना
            こまる|komaru|困る|to be in trouble|मुश्किल में पड़ना
            きんちょうする|kinchou suru|緊張する|to be nervous|घबराना / तनाव
            しんぱいする|shinpai suru|心配する|to worry|चिंता करना
            たのしみ|tanoshimi|楽しみ|looking forward to|उत्सुकता
        ...
        L.ja("j4-03", "School & study", "📚", "Homework, exams, lessons — the words of a student.", "N4", """
            ...
            じゅぎょう|jugyou|授業|class / lesson|कक्षा
            きょうかしょ|kyoukasho|教科書|textbook|पाठ्य-पुस्तक
            もんだい|mondai|問題|problem / question|समस्या / प्रश्न
            こたえ|kotae|答え|answer|उत्तर
        ...
        L.ja("j4-04", "Work & business", "💼", "Meetings, colleagues and business trips.", "N4", """
            ...
            しゃちょう|shachou|社長|company president|कंपनी के मालिक
            どうりょう|douryou|同僚|colleague|सहकर्मी
            しゃいん|shain|社員|employee|कर्मचारी
            きゃく|kyaku|客|customer / guest|ग्राहक
        ...
        L.ja("j4-05", "Travel & transport II", "🚆", "Tickets, departures, arrivals and reservations.", "N4", """
            ...
            とうちゃく|toucha|到着|arrival|आगमन
            よやく|yoyaku|予約|reservation|आरक्षण
            りょこう|ryokou|旅行|trip / travel|यात्रा
            まちあわせ|machiawase|待ち合わせ|meeting up (with someone)|मिलने की जगह
            ふね|fune|船|ship / boat|जहाज़
        ...
        L.ja("j4-06", "Directions & traffic", "🗺️", "Turn, cross, go straight — navigate a city.", "N4", """
            ...
            わたる|wataru|渡る|to cross|पार करना
            とまる|tomaru|止まる|to stop|रुकना
            すすむ|susumu|進む|to go forward|आगे बढ़ना
            こうさてん|kousaten|交差点|intersection|चौराहा
        ...
        L.ja("j4-07", "House & furniture", "🏠", "Rooms, windows, keys and the things inside.", "N4", """
            ...
            かぎ|kagi|鍵|key / lock|चाबी
            でんき|denki|電気|electricity / light|बिजली / रोशनी
            つくえ|tsukue|机|desk|मेज़
            いす|isu|椅子|chair|कुर्सी
            れいぞうこ|reizouko|冷蔵庫|refrigerator|फ्रिज
        ...
        L.ja("j4-08", "Verbs: open & close", "🚪", "Transitive & intransitive pairs — the heart of Japanese verbs.", "N4", """
            ...
            しめる|shimeru|閉める|to close (tr.)|बंद करना
            しまう|shimaru|閉まる|to close (intr., closes)|बंद होना
            つける|tsukeru|付ける|to turn on / attach|चालू करना / लगाना
            つく|tsuku|付く|to be on / attached|चालू होना / लगना
            けす|kesu|消す|to turn off / erase|बंद करना / मिटाना
        ...
        L.ja("j4-10", "Communication", "📞", "Phone calls, emails, letters and introductions.", "N4", """
            ...
            こたえる|kotaeru|答える|to answer|जवाब देना
            しつもん|shitsumon|質問|question|प्रश्न
            はなしあう|hanashiau|話し合う|to discuss|चर्चा करना
            つたえる|tsutaeru|伝える|to convey / tell|बताना / पहुँचाना
    ...
    val patterns = listOf(
        L.jp("jpN4-a", "～た ことが あります — 'have done ~ before'", "〜たことがあります",
            "N4", "Past experience: ［verb-ta］＋ことが あります. It means you have experienced it at least once. Answer with あります (yes) or ありません (no).",
            "経験を表す。「〜たことがある」。",
            "「〜た ことが あります」= पहले कभी ~ किया है (अनुभव)।",
            """
                ★にほんに いったことが ありますか。|nihon ni itta koto ga arimasu ka|Have you ever been to Japan?|क्या आप कभी जापान गए हैं?
                ★すしを たべたことが あります。|sushi wo tabeta koto ga arimasu|I have eaten sushi before.|मैंने पहले सुशी खाई है।
                ★まだ みたことが ありません。|mada mita koto ga arimasen|I have never seen it.|मैंने इसे कभी नहीं देखा।
            """),
        L.jp("jpN4-b", "～ては いけません — 'must not ~'", "〜てはいけません",
            "N4", "Prohibition: ［て-form］＋は いけません. Often softened to ～ては だめ in casual speech.",
            "禁止の表現。「〜てはいけません」。",
            "「〜ては いけません」= ~ करना मना है (निषेध)।",
            """
                ★ここで たばこを すっては いけません。|koko de tabako wo sutte wa ikemasen|You must not smoke here.|यहाँ धूम्रपान मना है।
                ★しけんの ときは みては いけません。|shiken no toki wa mite wa ikemasen|You must not look during the exam.|परीक्षा में देखना मना है।
                ★おそく なっては いけませんよ。|osoku natte wa ikemasen yo|You mustn't be late.|देर नहीं करनी चाहिए।
            """),
        L.jp("jpN4-c", "～なくても いいです — 'don't have to ~'", "〜なくてもいいです",
            "N4", "Absence of obligation: ［verb-nai］＋くても いいです. The opposite of なければなりません.",
            "義務がないことを表す。「〜なくてもいい」。",
            "「〜なくても いいです」= ~ करना ज़रूरी नहीं है।",
            """
                ★きょうは しごとに いかなくても いいです。|kyou wa shigoto ni ikanakute mo ii desu|You don't have to go to work today.|आज काम पर जाना ज़रूरी नहीं है।
                ★まいにち れんしゅうしなくても いいです。|mainichi renshuu shinakute mo ii desu|You don't have to practice every day.|रोज़ अभ्यास करना ज़रूरी नहीं है।
                ★あしたは こなくても いいですか。|ashita wa konakute mo ii desu ka|Is it okay if I don't come tomorrow?|क्या कल न आना ठीक है?
            """),
        L.jp("jpN4-d", "Potential — ～ことが できます / ～られます", "〜ことができます",
            "N4", "Ability: ［dictionary form］＋ことが できます = 'can do ~'. Ichidan verbs also add ～られます (たべる→たべられる), godan verbs change the last sound to え-row (よむ→よめる).",
            "可能表現。「〜ことができます」「〜られます」「〜えます」。",
            "क्षमता: 「〜ことが できます」= ~ कर सकता हूँ। いちだん क्रिया में られます, गोदान में え-ध्वनि (よむ→よめる)।",
            """
                ★にほんごで はなすことが できます。|nihongo de hanasu koto ga dekimasu|I can speak Japanese.|मैं जापानी बोल सकता हूँ।
                ★およげますか。|oyogemasu ka|Can you swim?|क्या आप तैर सकते हैं?
                ★みずを のめます。|mizu wo nomemasu|I can drink the water.|मैं पानी पी सकता हूँ।
            """),
        L.jp("jpN4-e", "～ながら — 'while doing ~'", "〜ながら",
            "N4", "Two actions at once: ［verb-masu stem］＋ながら＋main verb. テレビを みながら たべます = I eat while watching TV.",
            "同時進行。「〜ながら」。",
            "「〜ながら」= ~ करते हुए (एक साथ दो काम)।",
            """
                ★おんがくを ききながら べんきょうします。|ongaku wo kikinagara benkyou shimasu|I study while listening to music.|मैं संगीत सुनते हुए पढ़ता हूँ।
                ★あるきながら はなしましょう。|arukinagara hanashimashou|Let's talk while walking.|चलते-चलते बात करते हैं।
                ★ごはんを たべながら はなさないで ください。|gohan wo tabenagara hanasanaide kudasai|Please don't talk while eating.|खाते हुए बात मत कीजिए।
            """),
        L.jp("jpN4-f", "～つもり — 'I intend to ~'", "〜つもり",
            "N4", "Intention: ［dictionary form / negative］＋つもり です. らいしゅう にほんへ いくつもりです = I intend to go to Japan next week.",
            "意図・予定。「〜つもり」。",
            "「〜つもり です」= मेरा इरादा है ~ करने का / ~ करने की योजना है।",
            """
                ★らいしゅう にほんへ いくつもりです。|raishuu nihon e iku tsumori desu|I intend to go to Japan next week.|मेरा इरादा अगले हफ़्ते जापान जाने का है।
                ★きょうは ねるつもりです。|kyou wa neru tsumori desu|I plan to sleep early today.|आज मैं सोने की योजना बना रहा हूँ।
                ★べんきょうするつもりは ありません。|benkyou suru tsumori wa arimasen|I don't intend to study.|मेरा पढ़ने का इरादा नहीं है।
            """),
        L.jp("jpN4-g", "～そうです — 'looks like ~'", "〜そうです（様子）",
            "N4", "Appearance: い-adj minus い (おいしい→おいしそう), な-adj plus そう, verb-masu stem plus そう. おいしそう = 'looks delicious'.",
            "様子・見た目を表す。「〜そうです」。",
            "「〜そうです」= ~ दिख रहा है (देखने से अनुमान)।",
            """
                ★その ケーキは おいしそうです。|sono keeki wa oishisou desu|That cake looks delicious.|वह केक स्वादिष्ट लग रहा है।
                ★かれは いそがしそうです。|kare wa isogashisou desu|He looks busy.|वह व्यस्त लग रहा है।
                ★あめが ふりそうです。|ame ga furisou desu|It looks like it's going to rain.|बारिश होने वाली लगती है।
            """),
        L.jp("jpN4-h", "～たら — 'if / when ~'", "〜たら",
            "N4", "Conditional: ［past form］＋ら. あした はれだったら、こうえんへ いきます = If it's sunny tomorrow, I'll go to the park.",
            "条件表現。「〜たら」。",
            "「〜たら」= अगर ~ तो / जब ~ तो (शर्त)।",
            """
                ★あめが ふったら、うちに います。|ame ga futtara, uchi ni imasu|If it rains, I'll stay home.|अगर बारिश हुई तो मैं घर रहूँगा।
                ★じかんが あったら、あいに いきます。|jikan ga attara, ai ni ikimasu|If I have time, I'll go to see you.|अगर समय मिला तो मिलने आऊँगा।
                ★べんきょうしたら、わかりますよ。|benkyou shitara, wakarimasu yo|If you study, you'll understand.|पढ़ोगे तो समझ आएगा।
            """),
        L.jp("jpN4-i", "～て あげる / くれる / もらう — giving & receiving", "〜てあげる・くれる・もらう",
            "N4", "Direction of the action: あげる = I do it for someone else; くれる = someone does it for me; もらう = I receive the favor. みずを かってくれました = He bought me water.",
            "恩恵の方向を表す授受表現。",
        ...
        L.jp("jpN4-j", "～やすい / にくい — 'easy to ~ / hard to ~'", "〜やすい・にくい",
            "N4", "［verb-masu stem］＋やすい = easy to do, ＋にくい = hard to do. かんじは おぼえにくい = Kanji are hard to memorize.",
            "「〜やすい」「〜にくい」で容易さ・困難さを表す。",
            "「〜やすい」= करना आसान, 「〜にくい」= करना मुश्किल।",
            """
                ★この ほんは よみやすいです。|kono hon wa yomiyasui desu|This book is easy to read.|यह किताब पढ़ने में आसान है।
                ★にほんごは はなすのが むずかしいですが、ききやすいです。|nihongo wa hanasu no ga muzukashii desu ga, kikiyasui desu|Japanese is hard to speak but easy to listen to.|जापानी बोलना मुश्किल है पर सुनना आसान है।
                ★この くつは はきにくいです。|kono kutsu wa hakini kui desu|These shoes are hard to put on.|ये जूते पहनने में मुश्किल हैं।
            """)
    )
}
