...
object TargetExamples {
    ...
    private fun enFrames(): Map<String, List<String>> = mapOf(
        "noun" to listOf(
            ...
            "The teacher wrote XKEYX on the board.",
        ...
        "other" to listOf(
            ...
            "The teacher explained how to use XKEYX.",
    ...
    private fun hiFrames(): Map<String, List<String>> = mapOf(
        ...
        "other" to listOf(
            ...
            "शिक्षक ने XKEYX का प्रयोग समझाया।",
    ...
    private fun esFrames(): Map<String, List<String>> = mapOf(
        "noun" to listOf(
            ...
            "La maestra escribió XKEYX en la pizarra.",
        ...
        "other" to listOf(
            ...
            "El profesor explicó cómo utilizar XKEYX.",
    ...
    private fun arFrames(): Map<String, List<String>> = mapOf(
        ...
        "other" to listOf(
            ...
            "ماذا يعني XKEYX هنا؟",
            "شرح المعلم كيفية استخدام XKEYX.",
    ...
    private fun frFrames(): Map<String, List<String>> = mapOf(
        "noun" to listOf(
            ...
            "L'enseignant a écrit XKEYX au tableau.",
        ...
        "other" to listOf(
            ...
            "L'enseignant a expliqué comment utiliser XKEYX.",
    ...
    private fun deFrames(): Map<String, List<String>> = mapOf(
        "noun" to listOf(
            ...
            "Der Lehrer schrieb XKEYX an die Tafel.",
        ...
        "other" to listOf(
            ...
            "Der Lehrer erklärte, wie man XKEYX benutzt.",
    ...
    private fun bnFrames(): Map<String, List<String>> = mapOf(
        ...
        "other" to listOf(
            ...
            "শিক্ষক ব্যাখ্যা করেছেন কিভাবে XKEYX ব্যবহার করতে হয়।",
    ...
    private fun taFrames(): Map<String, List<String>> = mapOf(
        "noun" to listOf(
            ...
            "ஆசிரியர் பலகையில் XKEYX என்று எழுதினார்.",
        ...
        "other" to listOf(
            ...
            "XKEYX ஐ எவ்வாறு பயன்படுத்துவது என்பதை ஆசிரியர் விளக்கினார்.",
    ...
    private fun teFrames(): Map<String, List<String>> = mapOf(
        "noun" to listOf(
            ...
            "టీచర్ బోర్డు మీద XKEYX అని రాశారు.",
        ...
        "other" to listOf(
            ...
            "XKEYXని ఎలా ఉపయోగించాలో ఉపాధ్యాయులు వివరించారు.",
    ...
    private fun urFrames(): Map<String, List<String>> = mapOf(
        ...
        "other" to listOf(
            ...
            "استاد نے XKEYX کو استعمال کرنے کا طریقہ بتایا۔",
    ...
    private fun knFrames(): Map<String, List<String>> = mapOf(
        "noun" to listOf(
            ...
            "ಶಿಕ್ಷಕರು ಬೋರ್ಡ್‌ನಲ್ಲಿ XKEYX ಎಂದು ಬರೆದಿದ್ದಾರೆ.",
        ...
        "other" to listOf(
            ...
            "XKEYX ಅನ್ನು ಹೇಗೆ ಬಳಸುವುದು ಎಂದು ಶಿಕ್ಷಕರು ವಿವರಿಸಿದರು.",
