...
- 📐 **Grammar patterns** — JLPT/CEFR patterns plus Genki 1 and JFZ grammar, taught as *patterns with audio examples*, explained in English, Japanese *and your native language*. Every pattern shows **at least ten example sentences** with a **Load 10 more** button to page through more (extra hand-written sentences plus smart borrowing from related patterns fill any gaps). Every pattern also has a **🎯 Practice** button, and the Grammar tab has a dedicated **Practice** section behind a *Patterns / Practice* toggle: hand-written drills for every topic that needs one — tenses, articles, prepositions, modals, conditionals, reported speech, comparatives and more. Crucially, all four answer options are the *same sentence* differing only in the grammar point being tested ("I am a boy" vs "I was a boy" vs "I is a boy"), so the drill can't be passed by guesswork the way a set of unrelated sentences can. See `docs/PRACTICE.md`.
